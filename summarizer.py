...
SELECT_PROMPT = f"""أنت محرر نشرة أخبار متخصص في الذكاء الاصطناعي، تكتب لقارئ عربي مهتم بالتقنية.
...
3. اختر بحد أقصى {config.TARGET_ITEMS} أخبار فقط، ويمكن أن ترجع عددًا أقل إذا لم توجد أخبار كافية تستحق الإرسال.
